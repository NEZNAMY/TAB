...
public class EventListener implements Listener {
	...
	public void a(PlayerToggleSneakEvent e) {
		...
		if (!feature.isDisabledWorld(p.getWorldName())) 
			TAB.getInstance().getCPUManager().runMeasuredTask("processing PlayerToggleSneakEvent", TabFeature.NAMETAGX, UsageType.PLAYER_TOGGLE_SNEAK_EVENT, () -> p.getArmorStandManager().sneak(e.isSneaking()));
	}
