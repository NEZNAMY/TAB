 ...
 */
public class NumberedStableDynamicLine extends ScoreboardLine {
	...
	public void register(ITabPlayer p) {
		...
		if (prefixsuffix == null) return;
		PacketAPI.registerScoreboardScore(p, teamName, getPlayerName(), prefixsuffix.get(0), prefixsuffix.get(1), ObjectiveName, lineID);
	}
