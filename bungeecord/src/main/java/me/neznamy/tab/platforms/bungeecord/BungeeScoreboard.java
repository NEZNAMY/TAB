 ...
 */
public class BungeeScoreboard extends Scoreboard {
    ...
    public void setDisplaySlot(DisplaySlot slot, @NonNull String objective) {
        ((BungeeTabPlayer)player).sendPacket(new ScoreboardDisplay((byte)slot.ordinal(), objective));
    }

    @Override
    public void registerObjective0(@NonNull String objectiveName, @NonNull String title, boolean hearts) {
        ((BungeeTabPlayer)player).sendPacket(new ScoreboardObjective(objectiveName, jsonOrRaw(title, player.getVersion()), hearts ? ScoreboardObjective.HealthDisplay.HEARTS : ScoreboardObjective.HealthDisplay.INTEGER, (byte) 0));
    }

    @Override
    public void unregisterObjective0(@NonNull String objectiveName) {
        ((BungeeTabPlayer)player).sendPacket(new ScoreboardObjective(objectiveName, "", null, (byte) 1));
    }

    @Override
    public void updateObjective0(@NonNull String objectiveName, @NonNull String title, boolean hearts) {
        ((BungeeTabPlayer)player).sendPacket(new ScoreboardObjective(objectiveName, jsonOrRaw(title, player.getVersion()), hearts ? ScoreboardObjective.HealthDisplay.HEARTS : ScoreboardObjective.HealthDisplay.INTEGER, (byte) 2));
    }
    ...
    public void registerTeam0(@NonNull String name, String prefix, String suffix, String visibility, String collision, Collection<String> players, int options) {
        ...
        ((BungeeTabPlayer)player).sendPacket(new Team(name, (byte) 0, jsonOrRaw(name, player.getVersion()),
    ...
    public void unregisterTeam0(@NonNull String name) {
        ((BungeeTabPlayer)player).sendPacket(new Team(name));
    }
    ...
    public void updateTeam0(@NonNull String name, String prefix, String suffix, String visibility, String collision, int options) {
        ...
        ((BungeeTabPlayer)player).sendPacket(new Team(name, (byte) 2, jsonOrRaw(name, player.getVersion()),
                jsonOrRaw(prefix, player.getVersion()), jsonOrRaw(suffix, player.getVersion()),
    ...
    public void setScore0(@NonNull String objective, @NonNull String playerName, int score) {
        ((BungeeTabPlayer)player).sendPacket(new ScoreboardScore(playerName, (byte) 0, objective, score));
    }

    @Override
    public void removeScore0(@NonNull String objective, @NonNull String playerName) {
        ((BungeeTabPlayer)player).sendPacket(new ScoreboardScore(playerName, (byte) 1, objective, 0));
    }
}
