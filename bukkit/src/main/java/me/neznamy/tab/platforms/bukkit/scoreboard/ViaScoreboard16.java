 ...
 */
public class ViaScoreboard16 extends ViaScoreboard13 {
     ...
     */
    public ViaScoreboard16(@NonNull BukkitTabPlayer player) {
    ...
    protected ViaScoreboard16(@NonNull BukkitTabPlayer player, @NonNull Class<? extends Protocol> protocol, @NonNull PacketType setDisplayObjective, @NonNull PacketType setObjective, @NonNull PacketType setScore, @NonNull PacketType setPlayerTeam) {
