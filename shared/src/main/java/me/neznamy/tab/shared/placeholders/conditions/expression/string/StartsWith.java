...
/**
 * An expression that checks if the left side starts with the right side.
 */
public class StartsWith extends ComparatorExpression {

    /**
     * Constructs a new StartsWith expression with the specified left and right sides.
     *
     * @param   sides
    ...
    public ConditionalExpression invert() {
        return new NotStartsWith(new String[] {leftSide, rightSide});
    }
