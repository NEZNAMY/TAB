...
class KryptonPlaceholderRegistry(private val plugin: Main) : PlaceholderRegistry {
    ...
    override fun registerPlaceholders(manager: PlaceholderManager) {
        ...
        manager.registerServerPlaceholder("%mspt_percentile95_10s%", 10000) { mspt.poll(MillisPerTick.SECONDS_10).percentile95th() }
        ...
        manager.registerServerPlaceholder("%mspt_percentile95_1m%", 1000000) { mspt.poll(MillisPerTick.SECONDS_10).percentile95th() }
