package me.neznamy.tab.platforms.fabric.v1_16_5;
...
public class FabricTAB implements VersionLoader {
    ...
    public List<String> getSupportedVersions() {
        return Collections.singletonList("1.16.5");
    }
    ...
    public String getName(Level level) {
        ...
        switch (path) {
            case "overworld":
                dimensionSuffix = ""; // No suffix for overworld
                break;
            case "the_nether":
                dimensionSuffix = "_nether";
                break;
            default:
                dimensionSuffix = "_" + path; // End + default behavior for other dimensions created by mods
                break;
        }
