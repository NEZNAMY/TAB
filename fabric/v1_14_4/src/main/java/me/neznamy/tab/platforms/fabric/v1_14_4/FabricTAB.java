package me.neznamy.tab.platforms.fabric.v1_14_4;
...
public class FabricTAB implements VersionLoader {
    ...
    public List<String> getSupportedVersions() {
        return Collections.singletonList("1.14.4");
    }
    ...
    public EntityData createDataWatcher(TabPlayer viewer, byte flags, String displayName, boolean nameVisible) {
        ...
        data.define(new EntityDataAccessor<>(13, EntityDataSerializers.BYTE), (byte)16);
        return () -> data;
    }
