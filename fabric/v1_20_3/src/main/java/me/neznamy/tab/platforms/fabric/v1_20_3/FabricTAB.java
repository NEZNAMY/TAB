...
public class FabricTAB implements VersionLoader {
    ...
    public List<String> getSupportedVersions() {
        return Collections.singletonList("1.20.3 Release Candidate 1");
    }
    ...
    public double getMSPT() {
        return (float) ((FabricPlatform)TAB.getInstance().getPlatform()).getServer().getAverageTickTimeNanos() / 1000000;
    }
    ...
    public int getSpawnedPlayer(Object spawnPacket) {
        return ((ClientboundAddEntityPacket) spawnPacket).getId();
    }
    ...
    @Override
    public Packet<?> setScore(String objective, String scoreHolder, int score, Component displayName,
                              @Nullable Component numberFormat) {
    ...
    public Packet<?> removeScore(String objective, String scoreHolder) {
        return new ClientboundResetScorePacket(scoreHolder, objective);
    }
}
