package me.neznamy.tab.platforms.fabric.v1_20_2;
...
public class FabricPipelineInjector extends NettyPipelineInjector {
    ...
    protected Channel getChannel(@NotNull TabPlayer player) {
        Connection c = (Connection) ReflectionUtils.getFields(ServerCommonPacketListenerImpl.class, Connection.class)
